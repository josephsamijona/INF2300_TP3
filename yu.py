...
class Game:
    ...
    def run(self):
        ...
        if selected_language:
            self.play_trailer(selected_language)
        pygame.quit()
        sys.exit()
    ...
    def play_trailer(self, language_key):
...
class LanguageSelectionMenu:
    def __init__(self, screen, background_color, white, black):
        ...
        self.flags = {
            ...
            "français": ("Français", pygame.image.load("assets/images/flags/france.png")),
        ...
        self.fonts = {
            ...
            "français": pygame.font.Font("assets/fonts/PIXEL LATIN.ttf", 20),
...
class TrailerPlayer:
    ...
    def play(self, language_key):
        ...
        audio_files = {
            ...
            'français': 'assets/song/dube/version_fr.mp3',
