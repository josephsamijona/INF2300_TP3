...
def run_adventure_mode():
    ...
    #button images
    potion_img = pygame.image.load('assets/img/Icons/potion.png').convert_alpha()
    ...
    #sword image
    sword_img = pygame.image.load('assets/img/Icons/sword.png').convert_alpha()
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_q:  # Check for 'q' key press
                    return  # Exit the adventure mode and return to the main menu
